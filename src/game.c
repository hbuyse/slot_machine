...
const Gain_t     gains[] =
{
    ...
    {.first = 'L', .second = 'O', .third = 'L', .gain = 400},
    {.first = 'L', .second = 'E', .third = 'S', .gain = 30},
    {.first = 'L', .second = 'O', .third = 'S', .gain = 250},
    {.first = 'N', .second = 'E', .third = 'O', .gain = 1000},
    {.first = 'N', .second = 'E', .third = 'S', .gain = 300},
    ...
    {.first = 'B', .second = 'B', .third = 'B', .gain = 200},
    {.first = 'E', .second = 'E', .third = 'E', .gain = 200},
    {.first = 'L', .second = 'L', .third = 'L', .gain = 200},
    {.first = 'N', .second = 'N', .third = 'N', .gain = 200},
    {.first = 'O', .second = 'O', .third = 'O', .gain = 200},
